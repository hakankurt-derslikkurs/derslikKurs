...
export default function WhatsAppButton() {
  const handleWhatsAppClick = () => {
    // WhatsApp için telefon numarasını environment variable'dan al
    const phoneNumber = process.env.NEXT_PUBLIC_WHATSAPP_PHONE
    const message = encodeURIComponent('Merhaba! Derslik Kurs hakkında bilgi almak istiyorum.')
    ...
    try {
      ...
      // Hata durumunda alternatif URL'yi dene
